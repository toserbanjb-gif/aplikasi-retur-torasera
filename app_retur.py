...
DAFTAR_SUPPLIER = [
    ...
    "PADMATIRTA", "PT PABRIK MINYAK PERNIAGA DAN INDUSTRI IKAN DORANG", "MARGA NUSARAYA", "SUMBER CIPTA MULTINIAGA"
]
...
# ==========================================
    ...
    with tab_edit:
        ...
        if df_inv_view.empty:
            ...
            # Pilih data berdasarkan nomor invoice & supplier
            ...
            if selected_str:
                ...
                data_ terpilih = df_inv_view[df_inv_view["id"] == selected_id].iloc[0]
